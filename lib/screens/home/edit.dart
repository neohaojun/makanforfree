...
class EditBuffetForm extends StatefulWidget {
  // final DocumentSnapshot buffet;
  // EditBuffetPage({this.buffet});
  @override
  _EditBuffetFormState createState() => _EditBuffetFormState();
}

class _EditBuffetFormState extends State<EditBuffetForm> {
  @override
  void initState() {
    super.initState();
